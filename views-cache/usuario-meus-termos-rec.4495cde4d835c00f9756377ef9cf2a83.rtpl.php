  ...
  <div class="content-inside">
    <div class="my-4">
      <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
        <li class="nav-item">
          <a style="background-color: #2E9AFE;color: white" class="nav-link active" id="home-tab" data-toggle="tab"
            role="tab" aria-controls="home" aria-selected="false"><b>Meus Termos - Recife - 
              <?php if( totalTermosIDRec($usuario["id_usuario"]) == 0 ){ ?>
              Nenhum Registrado
              <?php }elseif( totalTermosIDRec($usuario["id_usuario"]) == 1 ){ ?>
              <?php echo totalTermosIDRec($usuario["id_usuario"]); ?> Registrado
              <?php }else{ ?>
              <?php echo totalTermosIDRec($usuario["id_usuario"]); ?> Registrados
              <?php } ?> </b></a>
        ...
        <a style="width: 15%;" href="/usuario/todos-termos-rec"class="btn btn-primary btn-sm"><i class="fas fa-tasks"></i><b> Todos Termos</b></a>
      ...
      <div class="search" style="float: right">
        <form action="/usuario/meus-termos-rec" method="get">
        ...
        <table class="table table-hover table-sm   table-bordered">
          ...
          <tbody>
            ...
            <tr style="font-size: 15px;font-weight: normal;">
              ...
              <td>
                <center> <a style="width: 100%;" href="/usuario/meus-termos-rec/arquivos/<?php echo $value1["id_termos"]; ?>"
              ...
              <td>
                <center>
                  <a style="width: 100%;" href="/usuario/termo-situacao-rec/<?php echo $value1["id_termos"]; ?>"
              ...
              <?php }else{ ?>
              <td>
                <center><a style="width: 100%;" href="/usuario/termo-situacao-rec/<?php echo $value1["id_termos"]; ?>"
              ...
              <?php } ?>
              <td>
                <center> <a style="width: 100%;" href="/usuario/termo-visualizar-rec/<?php echo $value1["id_termos"]; ?>"
                    class="btn btn-primary btn-sm"><i class="fas fa-eye"></i><b> Verificar</b></a>
              <td>
                <center> <a style="width: 100%;" href="/usuario/termo/editar-rec/<?php echo $value1["id_termos"]; ?>"
                    class="btn btn-success btn-sm"><i class="fas fa-pen"></i><b> Alterar</b></a></center>
              </td>
              <td>
                <center><a style="width: 100%;" href="/usuario/termos-rec/delete/<?php echo $value1["id_termos"]; ?>"
