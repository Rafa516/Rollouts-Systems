    ...
    <div class="my-4">
      <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
        <li class="nav-item">
          <a style="background-color: #2E9AFE;color: white" class="nav-link active" id="home-tab" data-toggle="tab"
            role="tab" aria-controls="home" aria-selected="false"><b>Rollouts - Recife - 
              <?php if( totalRolloutsRec() == 0 ){ ?>
              Nenhum Registrado
              <?php }elseif( totalRolloutsRec() == 1 ){ ?>
              <?php echo totalRolloutsRec(); ?> Registrado
              <?php }else{ ?>
              <?php echo totalRolloutsRec(); ?> Registrados
              <?php } ?> </b></a>
      ...
      <?php if( $usuario["localidade"] =='Recife' ){ ?>    
       <a style="width: 15%;" href="/usuario/registrar-rollout-rec"class="btn btn-primary btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i><b> Registrar Rollout</b></a>
         ...
         <a style="width: 15%;" href="/usuario/meus-rollouts-rec"class="btn btn-success btn-sm"><i class="fa fa-server" aria-hidden="true"></i></i><b> Meus Rollouts</b></a>
      <?php } ?>
  <?php if( totalRolloutsRec() != 0 ){ ?>
      <div class="search" style="float: right">
        <form action="/usuario/todos-rollouts-rec" method="get">
