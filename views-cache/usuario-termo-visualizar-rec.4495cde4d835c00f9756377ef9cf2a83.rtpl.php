                      ...
                      <tbody>
                        ...
                        <table class="table table-hover table-bordered">
                          ...
                          <tbody>
                            ...
                            <a href="/usuario/termo/editar-rj/<?php echo $value["id_termos"]; ?>" class="btn btn-success btn-sm"><i
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-group" action="/usuario/termo/anexar-arquivo-rj/<?php echo $value["id_termos"]; ?>" method="post"
