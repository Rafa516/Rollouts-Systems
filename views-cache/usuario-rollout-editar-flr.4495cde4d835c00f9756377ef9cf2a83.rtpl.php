      ...
      <div class="container-fluid px-1 py-5 mx-auto">
        <div class="row d-flex justify-content-center">
          <div class="col-xl-12 col-lg-8 col-md-9 col-11 text-center">
            ...
            <form class="form-group" action="/usuario/rollouts/editar-flr/<?php echo $value["id_rollout"]; ?>" method="post"
          ...
          <table class="table table-hover table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td> <input name="dt_data_rollout" type="date" value="<?php echo $value["dt_data_rollout"]; ?>" class="form-control py-1" required></td>
