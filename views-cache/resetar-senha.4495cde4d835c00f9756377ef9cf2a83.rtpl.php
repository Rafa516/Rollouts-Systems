...
<html lang="pt-br">
	...
	<body>
		...
		<div class="form">
			<form class="login-form" action="resetar-senha" method="post">
		...
		<?php if( $profileMsg != '' ){ ?>
			...
			<div class="options-02">
				<p>Olá <b><?php echo $name; ?></b>, digite uma nova senha</p>
			</div>

			 <input type="hidden" name="code" value="<?php echo $code; ?>">

			<input class="user-login" type="password" name="senha"  placeholder="Digite sua nova senha" required>
