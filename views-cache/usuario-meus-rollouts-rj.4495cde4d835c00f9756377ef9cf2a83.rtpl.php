  ...
  <div class="content-inside">
    <div class="my-4">
      <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
        <li class="nav-item">
          <a style="background-color: #2E9AFE;color: white" class="nav-link active" id="home-tab" data-toggle="tab"
            role="tab" aria-controls="home" aria-selected="false"><b>Meus Rollouts - Rio de Janeiro - 
              <?php if( totalRolloutsIDRj($usuario["id_usuario"]) == 0 ){ ?>
              Nenhum Registrado
              <?php }elseif( totalRolloutsIDRj($usuario["id_usuario"]) == 1 ){ ?>
              <?php echo totalRolloutsIDRj($usuario["id_usuario"]); ?> Registrado
              <?php }else{ ?>
              <?php echo totalRolloutsIDRj($usuario["id_usuario"]); ?> Registrados
              <?php } ?> </b></a>
      ...
      <?php if( totalRolloutsIDRj($usuario["id_usuario"]) != 0 ){ ?>
       ...
       <a style="width: 15%;" href="/usuario/todos-rollouts-rj"class="btn btn-primary btn-sm"><i class="fas fa-tasks"></i><b> Todos Rollouts</b></a>

      <div class="search" style="float: right">
        <form action="/usuario/meus-rollouts-rj" method="get">
        ...
        <table class="table table-hover table-sm  table-bordered">
          ...
          <tbody>
            ...
            <tr style="font-size: 15px;font-weight: normal;">
              ...
              <td>
                <center> <a style="width: 100%;" href="/usuario/meus-rollouts/arquivos-rj/<?php echo $value1["id_rollout"]; ?>"
              ...
              <td>
                <center>
                  <a style="width: 100%;" href="/usuario/rollout-situacao-rj/<?php echo $value1["id_rollout"]; ?>"
              ...
              <td>
                <center><a style="width: 100%;" style="width: 80px;"
                    href="/usuario/rollout-situacao-rj/<?php echo $value1["id_rollout"]; ?>"
                    onclick="return confirm('Deseja alterar a situação do rollout do(a) <?php echo $value1["nome"]; ?>?')" type="button"
              ...
              <?php } ?>
              <td>
                <center> <a style="width: 100%;" href="/usuario/rollout-visualizar-rj/<?php echo $value1["id_rollout"]; ?>"
                    class="btn btn-primary btn-sm"><i class="fas fa-eye"></i><b> Verificar</b></a>
              <td>
                <center> <a style="width: 100%;" href="/usuario/rollout/editar-rj/<?php echo $value1["id_rollout"]; ?>"
                    class="btn btn-success btn-sm"><i class="fas fa-pen"></i><b> Alterar</b></a></center>
              </td>
              <td>
                <center><a style="width: 100%;" href="/usuario/rollouts-rj/delete/<?php echo $value1["id_rollout"]; ?>"
