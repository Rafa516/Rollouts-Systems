  ...
  <div class="content-inside">
    <div class="my-4">
      ...
      <div id="DivIdToPrint">
        ...
        acessos no equipamento que estarei flrebendo neste remanejamento.
        ...
        <div class="table-responsive">
          ...
          instalados no equipamento novo que estou flrebendo, e que validei o seu funcionamento.
          ...
          <div class="table-responsive">
            ...
            <b><i>Acessórios flrebidos\Mantidos</i></b><br>
      ...
      <?php if( $value["id_usuario"] == $usuario["id_usuario"] ){ ?>
      <a href="/usuario/rollout/editar-rj/<?php echo $value["id_rollout"]; ?>" class="btn btn-success btn-sm btn-sm"><i
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-group" action="/usuario/rollout/anexar-arquivo-rj/<?php echo $value["id_rollout"]; ?>" method="post"
