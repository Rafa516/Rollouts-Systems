              ...
              <table class="table table-hover table-bordered">
                ...
                <table class="table table-hover table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td> <textarea style="height: 110px;" class="form-control py-1"><?php echo $value["equipamentos_t"]; ?></textarea>
                      </td>
                    </tr>
                    ...
                    <table class="table table-hover table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td> <textarea style="height: 110px;"
                              class="form-control py-1"><?php echo $value["acessorios_t"]; ?> </textarea> </td>
                        </tr>
                        ...
                        <table class="table table-hover table-bordered">
                          ...
                          <tbody>
                              ...
                              <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td> <?php echo $value["finalidade"]; ?></td>
                                    <?php if( $value["termo"] == 'Entrega' ){ ?>
                                    <td>
                            ...
                            <a href="/admin/termo/editar/<?php echo $value["id_termos"]; ?>" class="btn btn-success btn-sm"><i
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-group" action="/admin/termo/anexar-arquivo/<?php echo $value["id_termos"]; ?>" method="post"
